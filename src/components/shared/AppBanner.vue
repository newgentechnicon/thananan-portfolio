...
<template>
	...
	>
		...
		<div class="w-full md:w-1/3 text-left">
			...
			>
				A Project Manager & System Analyst
			</p>
			<div class="flex justify-center sm:block">
				<a
					download="Thananan-Resume.pdf"
					href="/files/Thananan-Resume.pdf"
		...
		<div class="w-full md:w-2/3 text-right float-right">
			<img
				v-if="theme === 'light'"
				src="../../assets/images/saleman.svg"
				alt="Developer"
			/>
			<img
				v-else
				src="../../assets/images/saleman-dark.svg"
				alt="Developer"
			/>
		</div>
	</section>
